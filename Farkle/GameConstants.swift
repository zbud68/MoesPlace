...
struct GameConstants {
    ...
    struct PlayButton {
        ...
        static let Position = CGPoint(x: 0, y: 30)
        static let ZPosition = 2
    }
    ...
    struct Positions {
        static let GameTable = CGPoint()
        static let Menu = CGPoint()
        static let PlayButton = CGPoint()
        static let SettingsButton = CGPoint()
        static let HelpButton = CGPoint()
        static let RollButton = CGPoint()
    }
